...
public class AuthenFilter implements Filter {
   ...
   private static  List<String> USER_RESOURCE;
    ...
    public AuthenFilter() {
        ...
        ADMIN_RESOURCE.add("product.jsp");
        ADMIN_RESOURCE.add("order.jsp");
        ADMIN_RESOURCE.add("orderDetail.jsp");
        ADMIN_RESOURCE.add("createProducts.html");
        ...
        NON_AUTHEN_RESOURCE.add("LoginGoogleHandler");
        NON_AUTHEN_RESOURCE.add("top1Server.jsp");
    }   
